...
user1 = Person("Alice", 30, "0101110101001")
...
user1 = Student("allice", 23 , "010100101010")
user2 = Teacher("boo", 25 , "23233232323")
...
p1 = Person("python", 23, "1010010101")
p2 = Person("hihihi", 21, "3432432432")
